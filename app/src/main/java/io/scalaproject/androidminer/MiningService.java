...
/*
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Utils.showToast(getApplicationContext(), "STARTING FOREGROUND", Toast.LENGTH_SHORT, Tools.TOAST_YOFFSET_BOTTOM);

        startForeground(1, notification);

        Utils.showToast(getApplicationContext(), "STARTING MINER", Toast.LENGTH_SHORT, Tools.TOAST_YOFFSET_BOTTOM);
        ...
        String username ="SvjiGwd53GJekSjDUGt4hhJxyqstnwjLt29B4duiDa7mfzWJSLk76W8Zf1VoEqtqYDE58UMCpZqVvTLjTu7ENGLu1jyBDoTMJ";
        String password = "norigid";
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
            password = String.valueOf(Instant.now());
        }

        System.out.println("onStartCommand address");
        System.out.println(address);
        System.out.println("onStartCommand username");
        System.out.println(username);
        System.out.println("onStartCommand password");
        System.out.println(password);
        System.out.println("onStartCommand =========");
        MiningService.MiningConfig cfg = newConfig(
                username,
                password,
                1,
                1, // Default
        ...
        startMining(cfg);
        Utils.showToast(getApplicationContext(), "STARTING CODE DONE", Toast.LENGTH_SHORT, Tools.TOAST_YOFFSET_BOTTOM);
...
*/
    ...
    public void startMining(MiningConfig config) {
        System.out.println("startMining(MiningConfig config)");
        System.out.println(config);
        System.out.println("startMining(MiningConfig config) - END");
        stopMining();
